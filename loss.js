...
function checkBodyVisibility() {
  if (!workoutStarted || !singlePose || isFullBodyVisible(singlePose)) return;
...
function checkJumpingJackPosture() {
  ...
  let { leftWrist, rightWrist, leftAnkle, rightAnkle, nose } = singlePose;
  ...
  if (correctPosture) {
    score++;
  } else if (currentTime - lastInstructionTime > 5000) {
...
const feedbacks = {
  ...
  kneepushup: [
    "Keep your knees on the ground and core tight.",
    "Don't flare your elbows out too much.",
  ],
  "pushup rotation": [
    "Rotate your body after each push-up to engage your core.",
    "Keep your movements smooth and controlled.",
  ],
  "pushup-variation": [
    "Switch push-up styles to target different muscles.",
    "Maintain proper form regardless of variation.",
  ],
  "Decline-Push-Up": [
    "Place your feet on a raised surface for intensity.",
    "Keep your back and neck aligned.",
  ],
  burpees: [
    "Explode upward with a jump after each push-up.",
    "Stay consistent with your tempo.",
  ],
  armcircle: [
  ...
  "cobra stretch": [
    "Push your upper body up gently using your palms.",
    "Relax your lower body to deepen the stretch.",
  ],
  "shoulder stretch": [
    "Keep your shoulders relaxed and switch arms halfway.",
...
function startRest(seconds) {
  ...
  let count = seconds;
  timer.innerText = count;
  currentCallback = () => startExercise(60, getExerciseName(currentExercise), startRest);
  ...
  restInterval = setInterval(() => {
    ...
    if (count < 0) {
      ...
      startExercise(60, getExerciseName(currentExercise), startRest);
    }
  }, 1000);
}
